...
public class DragController : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    public UnityEvent<int, int> onPositionChange;
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        initialPos = currentTransform.GetSiblingIndex();
    }
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        if(currentTransform.GetSiblingIndex() != initialPos){
            onPositionChange.Invoke(initialPos, currentTransform.GetSiblingIndex());
        }
    }
}